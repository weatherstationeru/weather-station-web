...
const teamMembers = [
  ...
  { id: 3, initials: 'AA', name: 'Ammar Ali', role: 'Mechatronics Engineering', color: '#993356', linkedin: 'https://www.linkedin.com/in/ammar-ali-8588923b2' },
  ...
  { id: 6, initials: 'AS', name: 'Ahmed Soliman', role: 'Mechatronics Engineering', color: '#3a7bd5', linkedin: 'https://www.linkedin.com/in/ahmed-soliman-4261053b8' },
